...
def _shortest_path(intersections, roads, start, goal):
    open_list = [(calculate_distance_between_coordinates(intersections[start], intersections[goal]), start)]
    closed_list = set()
    ...
    while open_list:
        ...
        for neighbor in roads[current]:
            ...
            new_cost = cost[current] + calculate_distance_between_coordinates(intersections[current],
                                                                              intersections[neighbor])

            if neighbor not in cost or new_cost < cost[neighbor]:
                cost[neighbor] = new_cost
                priority = new_cost + calculate_distance_between_coordinates(intersections[neighbor],
                                                                             intersections[goal])
    ...
    print(
        _shortest_path(
            ...
            roads=[[36, 34, 31, 28, 17], [35, 31, 27, 26, 25, 20, 18, 17, 15, 6], [39, 36, 21, 19, 9, 7, 4],
                   ...
                   [39, 36, 34, 31, 0, 12, 17],
                   [38, 37, 32, 22, 23], [33, 8, 14, 16], [34, 0, 1, 10, 12, 15, 17, 18, 25, 26, 27, 28],
                   [38, 5, 23, 29],
                   [8, 14, 30], [0, 12, 17, 25, 26, 28, 31], [1, 3, 6, 11, 15, 20], [39, 0, 2, 4, 7, 9, 28],
                   [12, 16, 22, 29],
